...
export const notes = [
...

  {
    ...
    facts: [
      "The Google Chrome Study Extension, her Chrome extension study tracker, exists because a plain timer wasn't enough to make her open it: focus time earns currency, which buys items in a shop, and the items feed the attribute XP that levels up a slime with a class and an adventurer rank.",

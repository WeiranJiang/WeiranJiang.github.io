...
export const notes = [
...

  {
    ...
    facts: [
      ...
      "Kayaking when the weather allows. The site's photo is of the rapids in Argo Park in Ann Arbor.",
      ...
      "Thrifting, doodling and baking. There's a fruit tart of hers on the site, strawberries, kiwi and blueberries over pastry cream.",
...

  {
    ...
    keywords:
      "fun fact interesting unusual surprising quirky story anecdote slime slimetime bridges balsa applebees host patent middle school etsy poetry debate tedx tennis captain competitive building structure coding financial model",
    use: "For a light question, one fact is the whole answer. Pick the one that fits and resist adding a second.",
    facts: [
      "SlimeTime, her Chrome extension study tracker, exists because a plain timer wasn't enough to make her open it: focus time earns Dewdrops, Dewdrops buy items in a shop, and items feed the attribute XP that levels up a slime with a class and an adventurer rank.",
